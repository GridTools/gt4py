...
def test_intervalinfo_overlap():
    overlap = overlap_with_extent(IntervalInfo(start=(0, -1), end=(0, 2)), (0, 2))
    assert overlap == (0, IntervalInfo.MAX_INT)

    overlap = overlap_with_extent(IntervalInfo(start=(0, -1), end=(1, 0)), (0, 2))
    assert overlap == (0, 2)

    overlap = overlap_with_extent(IntervalInfo(start=(0, -3), end=(0, -1)), (0, 0))

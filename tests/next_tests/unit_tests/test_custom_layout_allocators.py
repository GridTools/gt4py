...
class D0(common.DimensionIndex, kind=common.DimensionKind.HORIZONTAL): ...


class D1(common.DimensionIndex, kind=common.DimensionKind.HORIZONTAL): ...


class D2(common.DimensionIndex, kind=common.DimensionKind.HORIZONTAL): ...


class D0_vertical(common.DimensionIndex, kind=common.DimensionKind.VERTICAL): ...


class D1_local(common.DimensionIndex, kind=common.DimensionKind.LOCAL): ...


class D2_vertical(common.DimensionIndex, kind=common.DimensionKind.VERTICAL): ...


class D2_local(common.DimensionIndex, kind=common.DimensionKind.LOCAL): ...


class D1_vertical(common.DimensionIndex, kind=common.DimensionKind.VERTICAL): ...

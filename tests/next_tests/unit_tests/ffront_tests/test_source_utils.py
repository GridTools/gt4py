...
the enclosing function's. `get_closure_vars_from_function` therefore takes the global
names from the compiler's symbol table of the source, which covers nested scopes.
...
def test_free_variables_still_resolve_through_the_parser():
    @gtx.field_operator

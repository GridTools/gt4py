...
def test_tree_map_tuple_nested(_unary_fun):
    ...
    result = _apply(im.call(im.call("tree_map_tuple")(_unary_fun))(im.ref("t", nested)))
...
def test_map_tuple_single_arg(_unary_fun):
    result = _apply(im.call(im.call("map_tuple")(_unary_fun))(im.ref("t", i_tuple_field)))
...
def test_apply_infers_uninferred_expr(_unary_fun):
    ...
    assert result == im.make_tuple(im.call(_unary_fun)("a"), im.call(_unary_fun)("b"))

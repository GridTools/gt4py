...
def test_simple_splitable_ac_source_full_consume():
    """There are two consumer and two producer, each consumer consume all the data
    that the corresponding producer has generated.
    """

    sdfg = dace.SDFG(util.unique_name("simple_splitable_ac_source_full_consume"))

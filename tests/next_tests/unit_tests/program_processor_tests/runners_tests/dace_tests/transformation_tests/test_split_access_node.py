...
def test_map_producer_ac_consumer():
    ...
    sdfg = dace.SDFG(gtx_transformations.utils.unique_name("map_producer_ac_consumer"))
...
def test_map_producer_map_consumer():
    ...
    sdfg = dace.SDFG(gtx_transformations.utils.unique_name("map_producer_map_consumer"))
    state = sdfg.add_state(is_start_block=True)
...
def test_ac_producer_ac_consumer():
    sdfg = dace.SDFG(gtx_transformations.utils.unique_name("ac_producer_ac_consumer"))
    state = sdfg.add_state(is_start_block=True)
...
def test_ac_producer_map_consumer():
    sdfg = dace.SDFG(gtx_transformations.utils.unique_name("ac_producer_map_consumer"))
    state = sdfg.add_state(is_start_block=True)
...
def test_simple_splitable_ac_source_not_full_consume():
    ...
    """
    sdfg = dace.SDFG(
        gtx_transformations.utils.unique_name("simple_splitable_ac_source_not_full_consume")
    )
    state = sdfg.add_state(is_start_block=True)
...
def test_simple_splitable_ac_source_multiple_consumer():
    ...
    """
    sdfg = dace.SDFG(
        gtx_transformations.utils.unique_name("simple_splitable_ac_source_multiple_consumer")
    )
    state = sdfg.add_state(is_start_block=True)
...
def _make_transient_producer_sdfg(
    ...
    sdfg = dace.SDFG(
        gtx_transformations.utils.unique_name(
            "partial_ac_read" + ("_partial_read" if partial_read else "_full_read")
        )
    )
    state = sdfg.add_state(is_start_block=True)
...
def test_overlapping_consume_ac_source():
    ...
    sdfg = dace.SDFG(gtx_transformations.utils.unique_name("overlapping_consume_ac_source"))
    state = sdfg.add_state(is_start_block=True)
...
def test_same_producer():
    sdfg = dace.SDFG(gtx_transformations.utils.unique_name("same_producer"))
    state = sdfg.add_state(is_start_block=True)
...
def test_ac_producer_complex_ac_consumer():
    ...
    c[14:19] -> e[27:32]
    """
    sdfg = dace.SDFG(gtx_transformations.utils.unique_name("ac_producer_complex_ac_consumer"))
    state = sdfg.add_state(is_start_block=True)
...
def test_ac_producer_ac_consumer_complex():
    ...
    b[33:38] -> e[34:39]
    """
    sdfg = dace.SDFG(gtx_transformations.utils.unique_name("ac_producer_ac_consumer_complex"))
    state = sdfg.add_state(is_start_block=True)
...
def test_unused_partial_read_from_inout_node():
    ...
    t[5:10] -> c[5:10]
    """
    sdfg = dace.SDFG(gtx_transformations.utils.unique_name("full_write_from_global_to_split_node"))
    for data in "abc":

...
def _make_not_apply_because_of_write_to_g_sdfg() -> dace.SDFG:
    ...
    sdfg = dace.SDFG(gtx_transformations.utils.unique_name("not_apply_because_of_write_to_g_sdfg"))
...
def _make_eligible_sdfg_1() -> dace.SDFG:
    ...
    """
    sdfg = dace.SDFG(gtx_transformations.utils.unique_name("_make_eligible_sdfg_1"))
...
def _make_multiple_temporaries_sdfg1() -> dace.SDFG:
    ...
    sdfg = dace.SDFG(gtx_transformations.utils.unique_name("multiple_temporaries"))
...
def _make_multiple_temporaries_sdfg2() -> dace.SDFG:
    ...
    """
    sdfg = dace.SDFG(gtx_transformations.utils.unique_name("multiple_temporaries_sequential"))
...
def _make_wb_single_state_sdfg() -> dace.SDFG:
    ...
    """
    sdfg = dace.SDFG(gtx_transformations.utils.unique_name("single_state_write_back_sdfg"))
...
def _make_non_eligible_sdfg_with_branches():
    ...
    sdfg = dace.SDFG(gtx_transformations.utils.unique_name("non_eligible_sdfg_with_branches_sdfg"))
...
def _make_write_into_global_at_t_definition() -> tuple[
    ...
    """
    sdfg = dace.SDFG(gtx_transformations.utils.unique_name("write_into_global_at_t_definition"))
    state1 = sdfg.add_state(is_start_block=True)
    state2 = sdfg.add_state_after(state1)

...
def test_tuple_output(program_processor, stencil, column_axis):
...
def test_tuple_of_tuple_of_field_output(program_processor, column_axis):
    program_processor, validate = program_processor
...
def test_tuple_of_tuple_of_field_input(program_processor, column_axis):
    program_processor, validate = program_processor

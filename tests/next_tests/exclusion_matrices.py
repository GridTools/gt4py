...
BACKEND_SKIP_TEST_MATRIX = {
    OptionalProgramBackendId.DACE_CPU: [*GTFN_SKIP_TEST_LIST, (USES_CAN_DEREF, XFAIL, UNSUPPORTED_MESSAGE), (USES_CONSTANT_FIELDS, XFAIL, UNSUPPORTED_MESSAGE), (USES_DYNAMIC_OFFSETS, XFAIL, UNSUPPORTED_MESSAGE), (USES_INDEX_FIELDS, XFAIL, UNSUPPORTED_MESSAGE), (USES_LIFT_EXPRESSIONS, XFAIL, UNSUPPORTED_MESSAGE), (USES_ORIGIN, XFAIL, UNSUPPORTED_MESSAGE), (USES_REDUCTION_OVER_LIFT_EXPRESSIONS, XFAIL, UNSUPPORTED_MESSAGE), (USES_SPARSE_FIELDS, XFAIL, UNSUPPORTED_MESSAGE), (USES_TUPLE_ARGS, XFAIL, UNSUPPORTED_MESSAGE), (USES_TUPLE_RETURNS, XFAIL, UNSUPPORTED_MESSAGE), (USES_ZERO_DIMENSIONAL_FIELDS, XFAIL, UNSUPPORTED_MESSAGE)],
    ProgramBackendId.GTFN_CPU: [*GTFN_SKIP_TEST_LIST, (USES_STRIDED_NEIGHBOR_OFFSET, XFAIL, BINDINGS_UNSUPPORTED_MESSAGE)],
    ProgramBackendId.GTFN_CPU_IMPERATIVE: [*GTFN_SKIP_TEST_LIST, (USES_STRIDED_NEIGHBOR_OFFSET, XFAIL, BINDINGS_UNSUPPORTED_MESSAGE)],
    ProgramBackendId.GTFN_CPU_WITH_TEMPORARIES: [*GTFN_SKIP_TEST_LIST, (USES_DYNAMIC_OFFSETS, XFAIL, UNSUPPORTED_MESSAGE), (USES_STRIDED_NEIGHBOR_OFFSET, XFAIL, BINDINGS_UNSUPPORTED_MESSAGE)],

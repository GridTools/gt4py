...
from functional.iterator.builtins import unstructured_domain, deref, lift, named_range, shift
...
def test_strided_offset_provider(fencil_processor_no_gtfn_exec):
    ...
    run_processor(
        fencil, fencil_processor, LocA_size, out, inp
    )

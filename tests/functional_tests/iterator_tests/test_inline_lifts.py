...
def inline_lift_test_data():
    foo_shift = ir.FunCall(fun=ir.SymRef(id="shift"), args=[ir.OffsetLiteral(value="I"), ir.OffsetLiteral(value=1)])
    return [
        # (testee, expected)
        (
        ...
        (
            ...
            ir.FunCall(
                fun=ir.SymRef(id="f"),
                args=[ir.FunCall(fun=foo_shift,args=[ir.SymRef(id="arg")])]
            )
        ),
        (
            ...
            ir.FunCall(
                ...
                args=[
                    ir.FunCall(
                        fun=ir.SymRef(id="can_deref"),
                        args=[ir.SymRef(id="arg1")]
                    ),
                    ir.FunCall(
                        fun=ir.SymRef(id="can_deref"),
                        args=[ir.SymRef(id="arg2")]
                    ),
                ]
            )
        ),

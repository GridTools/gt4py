...
Numerical models, especially finite difference methods, commonly have different computation near boundaries, for example using non-centered finite difference stencils, boundary conditions, or other grid-specific needs in certain parts of the domain.

Coupled with distributed memory parallelism, the requirements become clear.

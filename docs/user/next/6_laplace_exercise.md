...
def laplacian_numpy(
    ...
    edge_orientation_cell: np.array,
        ...
        uv_div = divergence(u, v, nx, ny, L, A, edge_orientation_cell, out = uv_div)
...
def laplacian_fvm(
    ...
    edge_orientation_vertex: gtx.Field[[V, V2EDim], float],
    edge_orientation_cell: gtx.Field[[C, C2EDim], float],
) -> gtx.Field[[E], float]:

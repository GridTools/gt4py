...
# Use the non-recursive 'iter_modules' (not 'walk_packages'): command modules
# live directly under 'scripts/', and recursing would make pkgutil do a bare
# '__import__' of subpackages, where the 'scripts/tests' subpackage collides
# with the repository's top-level 'tests' package on sys.path.

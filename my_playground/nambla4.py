...
def build_nambla4_gtir():
    edge_k_domain = im.call("unstructured_domain")(
        im.call("named_range")(itir.AxisLiteral(value=Edge.value), 0, "num_edges"),
        im.call("named_range")(itir.AxisLiteral(value=KDim.value), 0, "num_k_levels"),
    )
    edge_k_domain = im.call("cartesian_domain")(
        im.call("named_range")(itir.AxisLiteral(value=Edge.value), 0, "num_edges"),
        im.call("named_range")(itir.AxisLiteral(value=KDim.value), 0, "num_k_levels"),
    )
    ...
    nabla4prog = itir.Program(
        ...
        params=[
            ...
            itir.Sym(id="N"),
            itir.Sym(id="nab4"),
            itir.Sym(id="num_edges"),
            itir.Sym(id="num_k_levels"),
        ],
        declarations=[],
        body=[
            itir.SetAt(
    ...
    sdfg = dace_backend.build_sdfg_from_gtir(nabla4prog, arg_types, offset_provider)

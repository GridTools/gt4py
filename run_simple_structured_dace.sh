...
export SIMPLE_STRUCTURED_BACKEND="dace"
export GT4PY_BUILD_CACHE_LIFETIME="persistent"
export GT4PY_BUILD_CACHE_DIR="$ROOT_DIR/.cache_dace"

"$PYTHON_BIN" tests/next_tests/integration_tests/multi_feature_tests/ffront_tests/test_simple_structured.py \
  > out_dace.txt 2> err_dace.txt

echo "Done. Backend=dace, cache=$GT4PY_BUILD_CACHE_DIR/.gt4py_cache"
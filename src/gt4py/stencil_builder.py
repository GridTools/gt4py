...
class StencilBuilder:
    ...
    def __init__(
        ...
        *,
        ...
        self._defer_function = (
            options.backend_opts.pop("defer_function")
    ...
    def build(self) -> Type["StencilObject"]:
        ...
        if self._defer_function:
            stencil_class = self._defer_function(self)
        else:
    ...
    def with_options(
        ...
        self._defer_function = kwargs.pop("defer_function", None)

...
class Roundtrip(workflow.Workflow[stages.CompilableITIRProgram, stages.CompiledProgram]):
    ...
    def __call__(self, inp: stages.CompilableITIRProgram) -> stages.CompiledProgram:

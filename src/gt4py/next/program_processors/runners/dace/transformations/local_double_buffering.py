...
def _is_inner_read_a_scalar(
    ...
    Note:
        This function can inherently not handle the case of blocked loops, as in
        such cases, a number of data equal to the blocking size must be read, or less.
        This is hard to handle and since this transformation is run before blocking,
        there is no problem.
    """

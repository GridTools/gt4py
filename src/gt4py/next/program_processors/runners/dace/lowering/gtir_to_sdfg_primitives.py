...
def _create_field_operator(
    ...
    output_tree: MaybeNestedInTuple[gtir_to_sdfg_lambda.DataflowOutputEdge],
) -> gtir_to_sdfg_types.FieldopResult:
    """
    ...
    if isinstance(node_type, ts.FieldType):
        assert isinstance(output_tree, gtir_to_sdfg_lambda.DataflowOutputEdge)
...
def translate_as_fieldop(
    ...
    input_edges, output_edges = gtir_to_sdfg_lambda.translate_lambda_to_dataflow(

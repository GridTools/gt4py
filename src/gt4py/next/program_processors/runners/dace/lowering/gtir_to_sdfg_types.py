...
from gt4py.next.program_processors.runners.dace.lowering import gtir_domain, gtir_to_sdfg_lambda
...
class FieldopData:
    ...
    def get_local_view(
        ...
        if isinstance(self.gt_type, ts.FieldType):
            it_indices: dict[gtx_common.Dimension, gtir_to_sdfg_lambda.DataExpr]

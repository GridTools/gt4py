...
def make_dace_backend(
    ...
    horizontal_dimension_has_unit_stride: bool = config.UNSTRUCTURED_HORIZONTAL_HAS_UNIT_STRIDE,
    ...
    optimization_args = optimization_args | {
        ...
        if horizontal_dimension_has_unit_stride
        else None
    }
    ...
    return DaCeBackendFactory(  # type: ignore[return-value] # factory-boy typing not precise enough
        ...
        otf_workflow__bare_translation__horizontal_dimension_has_unit_stride=horizontal_dimension_has_unit_stride,

...
class DaCeTranslator(
    workflow.ChainableWorkflowMixin[
        ...
        stages.ProgramSource[languages.SDFGLanguageSettings],
    ],
    definitions.TranslationStep[languages.SDFGLanguageSettings],
):
    ...
    def __call__(
        ...
        module: stages.ProgramSource[languages.SDFGLanguageSettings] = stages.ProgramSource(
            ...
            library_deps=tuple(),
            language_settings=languages.SDFGLanguageSettings(),
        )
        return module

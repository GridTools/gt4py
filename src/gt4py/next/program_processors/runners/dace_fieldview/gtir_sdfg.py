...
class GTIRToSDFG(eve.NodeVisitor, SDFGBuilder):
    ...
    def visit_Lambda(
        ...
        for p_name, p_type in lambda_global_symbols.items():
...
def build_sdfg_from_gtir(
    ...
    sdfg.debuginfo = dace_utils.debug_info(ir)

...
class NumPySourceGenerator(PythonSourceGenerator):
    NATIVE_FUNC_TO_PYTHON = {
        ...
        gt_ir.NativeFunction.SINH: "np.sinh",
        gt_ir.NativeFunction.COSH: "np.cosh",
        gt_ir.NativeFunction.TANH: "np.tanh",
        gt_ir.NativeFunction.ARCSINH: "np.arcsinh",
        gt_ir.NativeFunction.ARCCOSH: "np.arccosh",
        gt_ir.NativeFunction.ARCTANH: "np.arctanh",
        gt_ir.NativeFunction.SQRT: "np.sqrt",
        gt_ir.NativeFunction.EXP: "np.exp",
        gt_ir.NativeFunction.LOG: "np.log",
        gt_ir.NativeFunction.GAMMA: "scipy.special.gamma",
        gt_ir.NativeFunction.CBRT: "np.cbrt",

...
class PythonSourceGenerator(gt_ir.IRNodeVisitor):
    ...
    NATIVE_FUNC_TO_PYTHON = {
        ...
        gt_ir.NativeFunction.SINH: "math.sinh",
        gt_ir.NativeFunction.COSH: "math.cosh",
        gt_ir.NativeFunction.TANH: "math.tanh",
        gt_ir.NativeFunction.ARCSINH: "math.asinh",
        gt_ir.NativeFunction.ARCCOSH: "math.acosh",
        gt_ir.NativeFunction.ARCTANH: "math.atanh",
        gt_ir.NativeFunction.SQRT: "math.sqrt",
        gt_ir.NativeFunction.EXP: "math.exp",
        gt_ir.NativeFunction.LOG: "math.log",
        gt_ir.NativeFunction.GAMMA: "math.gamma",

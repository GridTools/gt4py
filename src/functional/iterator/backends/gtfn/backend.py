...
def generate(program: itir.Program, *, grid_type: str, fn_backend: str, **kwargs) -> str:
    transformed = program
    ...
    gtfn_ir = GTFN_lowering().visit(transformed, grid_type=grid_type, fn_backend=fn_backend)

...
def _serialize_param(
    parameter: source_modules.ScalarParameter | source_modules.BufferParameter | source_modules.ConnectivityParameter,
) -> str:
    ...
    elif isinstance(parameter, source_modules.ConnectivityParameter):
